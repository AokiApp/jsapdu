...
object NfcPlatformHelper {
    ...
    private fun resolveAntennaInfo(adapter: NfcAdapter): NfcAntennaInfo? {
        ...
        return try {
            ...
            Log.d("NfcPlatformHelper", "Framework NfcAntennaInfo: ${fwInfo.deviceWidth} x ${fwInfo.deviceHeight}, antennas: ${fwInfo.availableNfcAntennas.size}, foldable: ${fwInfo.isDeviceFoldable}")
